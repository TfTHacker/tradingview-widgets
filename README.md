...
Use the command palette command **TradingView Widgets: Widget Wizard** to open a guided widget builder. It lets you choose the widget type, symbol(s), interval, theme, height, locale, timezone, attribution, lazy loading, and optional advanced YAML, then copies or inserts the generated code block.
